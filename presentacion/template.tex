...
\begin{frame}{Resumen}%{Problemática}
  ...
  \centering
  \includegraphics[width=0.45\textwidth,height=0.35\textheight]{cinves}$^\dag$
  \hfil
  \includegraphics[width=0.45\textwidth,height=0.35\textheight]{cinves}$^\dag$
  \vspace{2pt}
  \includegraphics[width=0.45\textwidth,height=0.35\textheight]{cinves}$^\dag$ 
...
\centering
\animategraphics[loop,width=4cm]{10}{data_aumentation-}{11}{32}
\end{frame}
...
\begin{frame}{Descripción del proyecto}
  ...
  \begin{minipage}{0.5\textwidth}
    \only<1>{\includegraphics[width=\textwidth]{cinves}$^\dag$\\
    ...
    \only<2>{\includegraphics[width=\textwidth]{cinves}$^\dag$\\
      \rule{0in}{1.2em}$^\dag$\scriptsize Hardware in the loop framework proposal for a semi-autonomous car architecture in a closed route environment \cite{CurielRamirez2019}
    }
    \only<3>{\includegraphics[width=\textwidth]{cinves}$^\dag$\\
      \rule{0in}{1.2em}$^\dag$\scriptsize Hardware in the loop framework proposal for a semi-autonomous car architecture in a closed route environment \cite{CurielRamirez2019}
    }
    \only<4>{\includegraphics[width=\textwidth]{cinves}$^\dag$\\
      \rule{0in}{1.2em}$^\dag$\scriptsize Hardware in the loop framework proposal for a semi-autonomous car architecture in a closed route environment \cite{CurielRamirez2019}
    }
    \only<5>{\includegraphics[width=\textwidth]{cinves}$^\dag$\\
      \rule{0in}{1.2em}$^\dag$\scriptsize Hardware in the loop framework proposal for a semi-autonomous car architecture in a closed route environment \cite{CurielRamirez2019}
    }
  \end{minipage}
\end{frame}

\section{Abstracción de caracteristicas}
\begin{frame}{Arquitectura híbrida}
  \begin{figure}
    \centering
    \includegraphics[scale=0.30]{cinves}$^\dag$\\
    \rule{0in}{1.2em}$^\dag$\scriptsize Hardware in the loop framework proposal for a semi-autonomous car architecture in a closed route environment \cite{CurielRamirez2019}\\
  \end{figure}
\end{frame}
...
\begin{frame}{Multi-robots}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.5\textwidth}
    \includegraphics[width=\textwidth]{cinves}$^\dag$\\
    \rule{0in}{1.2em}$^\dag$\scriptsize Hardware in the loop framework proposal for a semi-autonomous car architecture in a closed route environment \cite{CurielRamirez2019}
  \end{columns}
\end{frame}
...
\begin{frame}{Panorama Planificación de trayectorias}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.33]{cinves}
...
\begin{frame}{Representación del ambiente 3D}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.15]{cinves}
...
\section{Script de Data Aumentation}
\begin{frame}{Metodología/Cronograma}
  \begin{figure}
    \centering
    \includegraphics[width=11cm, height=8cm]{cinves}
  \end{figure}
\end{frame}

\section{Script de Obtención de rasgos}
